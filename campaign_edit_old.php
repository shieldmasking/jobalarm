									...
									<div class="form-body" style="padding-bottom:20px;">												
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="tab2">
                                                 <div class="row">
                                                    <div class="col-md-6">
                                                        <h3 class="font-lg">Select Tweets for Campaign</h3>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
				                                    <div class="col-md-12">
	    			                                    ...
	    			                                    <div class="col-md-6">
                                                            <h3 class="font-lg">Assigned Tweets</h3>
...
<![endif]-->
    ...
    <script src="inc/tweetedjobs-campaign-edit.js" type="text/javascript"></script>
    <script>
