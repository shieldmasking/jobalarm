...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed">
    ...
    <div class="page-header">
        ...
        <div class="page-header-menu" style="background-color:#444d58">
            <div class="container">
                <h1 style="width:340px;float:left;margin:0;padding:5px;color:white">Reports</h1>
                <!-- BEGIN MEGA MENU -->
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject theme-font bold uppercase">Job Activity Report</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div id="tweetclicks" class="chart" style="height: 400px;"></div>
                            </div>
                        </div>
                        <!-- END PORTLET-->
                    </div>
...
<!-- END PAGE LEVEL SCRIPTS -->
    <script src="inc/tweetedjobs-account-reports.js" type="text/javascript"></script>
<!--     <script>
