...
if (empty($_POST['email'])) { 
	...
	$query = "SELECT email FROM users WHERE email=".  escape_data($_POST['email']);
	...
	$query = "UPDATE users SET password=SHA('$p') WHERE email=$uid";
	$result = mysql_query ($query) or trigger_error("Query: $query\n<br />MySQL Error: " . mysql_error());
	if (mysql_affected_rows() == 1) { 
	$body = "Your password to log into JobAlarm has been temporarily changed to '$p'. Please log in using this password and your username. At that time you may change your password to something more familiar.";
	mail ($_POST['email'], 'Your temporary password.', $body, 'From: admin@jobalarm.com');
...
<div class="page-header">
	...
	<div class="page-header-menu">
		<div class="container">
			<h1 style="width: 600px;float:left;margin:0;padding:5px;color:white">Password Reset</h1>
