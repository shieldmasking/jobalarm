...
<head>
<meta charset="utf-8"/>
<title>JobAlarm | Special Offer</title>
...
<div class="page-header">
	...
	<div class="page-header-menu">
		<div class="container">
			<h1 style="width:320px;float:left;margin:0;padding:5px;color:white">Special Agreements</h1>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row margin-bottom-20">
							<div class="col-md-6">
								<div class>
								JobAlarm offers you the special opportunity to....
							...
							<div class="col-md-6">
								...
								<form id="contact" action="contact.php" method="post">
									<h3 class="form-section">Register</h3>
									<p>
									...
									<div class="form-group">
										<div class="input-icon">
											...
											<input id="contact_name" name="contact_name" type="text" class="form-control" placeholder="Name" required/>
										</div>
									</div>
									<div class="form-group">
										<div class="input-icon">
											<i class="fa fa-briefcase"></i>
											<input id="contact_company" name="contact_company" type="text" class="form-control" placeholder="Company" required/>
										</div>
									</div>
									<div class="form-group">
										<div class="input-icon">
									...
									<div class="form-group">
										<div class="input-icon">
											...
											<input id="contact_phone" name="contact_phone" type="text" class="form-control" placeholder="Phone #" required/>
										</div>
									</div>
									<div class="form-check">
										<label class="form-check-label">
										<input type="checkbox" class="form-check-input" id="agree" name="agree" required/>
										<strong>I agree to JobAlarm Terms & Conditions.</strong>
										</label>
										</div>
