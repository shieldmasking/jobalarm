									...
									<div class="form-body" style="padding-bottom:20px;">												
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
                                                 <div class="row">
                                                    <div class="col-md-6">
                                                        <h3 class="font-lg">Select Job Tweets to Sponsor (Limit 20)</h3>
                                                    </div>
                                                    <div class="col-md-6">
...
<![endif]-->
    ...
    <script src="inc/form-edit-wizard-ab.js"></script>
    ...
    <script src="inc/tweetedjobs-campaign-edit-ab.js" type="text/javascript"></script>
    <script>
