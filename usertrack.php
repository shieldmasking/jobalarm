...
//$dbData = Config::get('db')->get_results("select c.*, x.brandOrig as brandID from `clickTrack` c left join `candidateXref` as x on x.candidateId = c.candidateId where c.mobile !='0' and c.candidateId !=0 and c.brand =0");
		
//foreach($dbData as $update) {
//$mobile = $update['mobile'];
//$twitterid = $update['trackId'];
//$brand = $update['brandID'];

//Config::get('db')->query("update `clickTrack` set `brand` = {$brand} where `mobile` = '{$mobile}' and `trackId`='{$twitterid}'");
...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed">
        ...
        <div class="page-content">
            <div class="container">
                ...
                <div class="row margin-top-10">
                  ...
                  <div class="col-md-12 col-sm-12" id="ManageUserCell" style="left: 0px; top: 0px">
                        <!-- BEGIN PORTLET-->
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    <i class="icon-bar-chart theme-font hide"></i>
                                    <span class="caption-subject theme-font bold uppercase"><i class="fa fa-users"></i> - New Users</span>
                                </div>  
                                </div>                             
                            <div class="portlet-body">
	...
	<table class="table table-striped table-bordered table-hover" id="datatableUsern_ajax">								    <thead>	
...
<script src="inc/addUsers.js" type="text/javascript"></script>
