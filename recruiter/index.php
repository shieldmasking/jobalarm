...
header('location: ../login.php?p=2'); exit(); 
}
...
<head>
    <meta charset="utf-8" />
    <title>JobAlarm | Recruiter</title>
...
<style type="text/css">
	#datatableUsern_ajax_length,
	#datatableUsern_ajax_filter
	{
	display:none;
	}
	</style>
...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed">
    ...
    <div class="page-header">
        ...
        <div class="page-header-menu" style="background-color:#444d58">
            <div class="container">
                <h1 style="width:340px;float:left;margin:0;padding:5px;color:white">New Candidates</h1>
                <!-- BEGIN MEGA MENU -->
        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    <li>
                        <a href="../dashbets/index.php">Home</a>
                ...
                <div class="row margin-top-10">
                  ...
                  <div class="col-md-12 col-sm-12" id="traffic" style="left: 0px; top: 0px">
                        <!-- BEGIN PORTLET-->
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    <i class="icon-bar-chart theme-font hide"></i>
                                    <span class="caption-subject theme-font bold uppercase"><i class="fa fa-users"></i> - New Candidates
                                </div>  
                                </div>                             
                            <div class="portlet-body">
	...
	<table class="table table-striped table-bordered table-hover" id="datatableUsers_ajax">								    <thead>	
    ...
    <div class="page-footer">
        <div class="container">
            2015 &copy; Premier, SSG. All Rights Reserved.
        </div>
    </div>
...
tj.alex.initializeusersGrid();
//});
</script>
<script>
$(document).on("click", ".open-updateCand", function () {
     var candid = $(this).data('id');
     $(".modal-body #candid").val( candid );
	 //$('#updateCand').get(0).reset();
...
<div class="modal fade" id="updateCand" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                      <h4 class="modal-title">Text or Update Your Candidate.</h4>
                </div>
                <div id="trafficBody" class="modal-body">
				
					<div class="form-group">
					<label>Send a Text</label>
					<textarea maxlength="160" id="message" class="form-control" placeholder="Your text msg.." data-placement="top" data-trigger="manual"></textarea>
					</div>


                    <div class="form-group">
					<label>Set Group</label>
                			<select id="trafficGroup"  name="type" type="select" class="form-control" placeholder="Select">
                			<option value=0>Select Group....</option>
                			<option value=13>Texted</option>
							<option value=14>Interviewed</option>
							<option value=15>Offered</option>
							<option value=16>Hired</option>
                			<option value=17>Rejected</option></select>
          		      </div>
                    <div class="form-group">
					<label>Note</label>
					<textarea id="note" class="form-control" placeholder="Add a note.." data-placement="top" data-trigger="manual"></textarea>
					<input type="hidden" name="candid" id="candid" value=""/>
					</div>
              	    <div class="form-group"><button id="trafficButton" type="submit" class="btn btn-success pull-left">Send</button> <p class="help-block pull-left text-danger hide" id="form-error">&nbsp; The form is not valid. </p> &nbsp;&nbsp;<button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
                    </div>
