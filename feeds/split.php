...
$local_file = '/home/tweetedjobs/feeds/split.xml';
...
function getDataFeed(){
	$output_filename = '/home/tweetedjobs/feeds/split.xml';
	$dom = new DOMDocument();
	$dom->load('https://secure.jobappnetwork.com/commoncfmx/rss_feed/rss.cfm?c=split&Enhanced=1');
