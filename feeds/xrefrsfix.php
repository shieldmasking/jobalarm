...
$where = array('candidateId'=>4717);
        Config::get('db')->delete('candidateXref',$where);
		echo json_encode(array('success'=>true,'message'=>'Records Deleted'));
		Config::get('db')->delete('candidate_group',$where);
		echo json_encode(array('success'=>true,'message'=>'Records Deleted'));
		Config::get('db')->delete('note',$where);
		echo json_encode(array('success'=>true,'message'=>'Records Deleted'));
		Config::get('db')->delete('sms_messages',$where);
        echo json_encode(array('success'=>true,'message'=>'Records Deleted'));
		Config::get('db')->delete('candidateApply',$where);
        echo json_encode(array('success'=>true,'message'=>'Records Deleted'));
        return true;
