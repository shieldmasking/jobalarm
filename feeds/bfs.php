...
$local_file = '/home/tweetedjobs/feeds/hbb.xml';
...
function getDataFeed(){
	$output_filename = '/home/tweetedjobs/feeds/hbb.xml';
	$dom = new DOMDocument();
	$dom->load('https://secure.jobappnetwork.com/commoncfmx/rss_feed/rss.cfm?c=hbb&Enhanced=1');
