...
$local_file = '/home/tweetedjobs/feeds/bodega.xml';
...
$dbDelete = Config::get('db') -> query("delete from `job` where `brand`=297");
}
	
function getDataFeed(){
	$output_filename = '/home/tweetedjobs/feeds/bodega.xml';
	$dom = new DOMDocument();
	$dom->load('https://secure.jobappnetwork.com/commoncfmx/rss_feed/rss.cfm?c=bodega&Enhanced=1');
