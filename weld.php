						...
						<div class="row margin-bottom-20">
						  <div class="col-md-6">
								...
								<form action="jobs.php" id="cecform" name="cecform" method="post">
									...
									<h3 class="form-section"><strong>Need a welding job? </strong></h3>
									<p>
										 You are in the right place! 
									</p>
									<p>Please provide us with the following information and we will contact you via text or email when we have job openings that fit you.  <p>If you do not wish to be contacted, just put in your zip code and we will give you a list of welding jobs in your area.</p></p>
...
<option value="Formable">Welder</option>
<option value="Custom">Fitter</option>
<option value="Other">Helper</option></select>
</div>									
									...
									<div class="form-group">
										<div class="input-icon">
											<i class="fa fa-user"></i>
											<input id="contact_company" name="contact_company" type="text" class="form-control" placeholder="Last Name">
										</div>
									</div>
									<div class="form-group">
										<div class="input-icon">
									...
									<i class="fa fa-briefcase"></i>
									 ...
									 <input type="hidden" id="search_keyword" name="search_keyword" value="welder" />
