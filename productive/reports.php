    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="dashboard-stat blue-madison">
                ...
                <div class="details">
                    <div class="floatval" id="reportCanNumber">0</div>
                    <div class="desc">
                        Variance
                    </div>
                </div>
		...
		<div class="col-xl-3 col-md-6">
            <div class="dashboard-stat purple-plum">
                ...
                <div class="details">
                    <div class="text" id="reportPromoNumber">0</div>
                    <div class="desc">
                        Productivity
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="dashboard-stat red-intense">
                ...
                <div class="details">
                    <div class="text" id="reportCtrNumber">0</div>
                    <div class="desc">
                        Antepartum Variance
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="dashboard-stat green-haze">
                ...
                <div class="details">
                    <div class="text" id="reportMsgNumber">0</div>
                    <div class="desc">
                        Labor Variance
                    </div>
                </div>
