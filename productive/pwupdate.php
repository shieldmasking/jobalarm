...
$dbData = Config::get('db')->get_results("select u.*, `productiveUser` u LEFT JOIN `productiveAccount` as a on a.id = u.accountId where u.id={$user}");
        ...
        <div class="page-header-top">
            <div class="container">
				...
				<a href="index.php">
                    ...
                    <a href="index.php">
                        <img src="img/productive.png" alt="logo" class="logo-default" />
                    </a>
