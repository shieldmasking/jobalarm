...
if (isset($_POST['sitelogin'])) {
	...
	$query = "SELECT u.*, a.image, a.active as acctActive FROM productiveUser u LEFT JOIN productiveAccount as a on a.id = u.accountId WHERE u.email='{$email}' AND u.pwd='{$password}'";
...
<div class="page-header page-header-smaller">
	...
	<div class="page-header-top">
		<div class="container" style="margin:0 auto;padding:0">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<div align="center"><a href="index.php"><img src="/img/productive.png" longdesc="http://www.jobalarm.com/productive"></a>			    </div>
			</div>
			<!-- END LOGO -->
		</div>
	</div>
...
<div class="page-container login" style="margin-bottom:30px">
  ...
  <div class="row"><br>
    ...
    <a href="contact.php" id="forget-password" class="forget-password">Need Support?</a>
