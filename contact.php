...
if ( isset($_POST['email']) && isset($_POST['name']) && isset($_POST['text']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) ) {
  ...
  //send email
  mail( "info@jobalarm.biz", "JobAlarm Contact Form: ".$_POST['name'].$company, $_POST['name']."\r\n\r\n".$_POST['company']."\r\n\r\n".$_POST['email']."\r\n\r\n".$_POST['mobile']."\r\n\r\n".$_POST['text'], "From: JobAlarm ContactUs <info@jobalarm.biz>"  );
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="index.html"><img src="img/logo1.png" longdesc="http://www.jobalarm.biz"></a>			</div>
			<!-- END LOGO -->
					...
					<div class="col-md-12">
						...
						<div class="row margin-bottom-20">
								...
								<div class="well">
									<h4>Address</h4>
					                    <address class="margin-bottom-40">
					                        Harrelson Group LLC.<br />
					                     	Email: <a href="mailto:info@jobalarm.biz">info@jobalarm.biz</a><br /> 
							...
							<div class="col-md-6">
								...
								<!-- BEGIN FORM-->
								<form id="contact" action="contact.php" method="post" hidden>
									<h3 class="form-section">Contact Form</h3>
									<p>
										 Thank you for your interest in JobAlarm. Please fill out the form below.
									</p>
									...
									<div class="form-group">
										<textarea id="contact_feedback" name="contact_feedback" class="form-control" rows="3=6" placeholder="Which Company or Brand are you interested in?"></textarea>
									</div>
									<button id="submit_btn" type="submit" class="btn green" disabled>Submit</button>
									<div class="form-group">
