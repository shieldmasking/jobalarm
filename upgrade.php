...
if ($_SESSION['account']['billing_plan'] == 3) {
...
if (isset($_GET['pid'])) {
    if ($_GET['pid'] > 0 && $_GET['pid'] < 4) {
        ...
        if ($_GET['pid'] >= 2) {
            ...
            $_SESSION['account']['billing_hold'] = 0;
        }
        ...
        if ($_GET['pid'] == 2) {
			...
			$query = "update job set campaignId=0 where campaignId>0 and userName=".$_SESSION['account']['twitter_handle'];           
			Config::get('db')->query($query);
            $data = array(
            ...
            $query = "update campaign set status=0 where account_id=".$_SESSION['account']['id'];
            Config::get('db')->query($query);
			$query = "update job set campaignId=0 where campaignId>0 and userName=".$_SESSION['account']['twitter_handle'];           Config::get('db')->query($query);
            $data = array(
                'account_id'=>$_SESSION['account']['id'],
...
<?php if (!$billing_hold): ?>
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <div class="pricing hover-effect">
                                        ...
                                        <span class="font-lg style1"> <strong> <i>$1 Trial (then $19.00 per month</i>) </strong> </span> </div>
                                            <ul class="pricing-content list-unstyled">
                                        <li> <span class="style3">Includes 5 Sponsored Job Slots</span> </li>
                                        <li> <span class="style4"> Sponsor Placement In Top  Page of Search Results (when available) </span> </li>
                                        <li> <span class="style3">Unlimited Sponsored Clicks </span> </li>
                                        <li> <span class="style4">Ability to interchange Job Tweets at any time</span> </li>
                                        <li> <span class="style3">Track Clicks for Each Job Tweet</span> </li>
                                        <li> <span class="style4">Share to LOCAL JOB RELATED FACEBOOK GROUPS</span> </li>
                                        
                                      </ul>
                                      <div class="pricing-footer">
									  <?php if($account_data['billing_plan'] < 2): ?>
                                        <p></p>
...
<a href="javascript:;" onClick="setPaymentPlan();" class="btn btn-primary"> Try It For $1 <i class="m-icon-swapright m-icon-white"></i> </a> <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1" >
                                  ...
                                  <div class="col-md-4">
                                    <div class="pricing hover-effect">
                                        ...
                                        <li> <span class="style4">Ability to interchange Job Tweets at any time</span> </li>
                                        <li> <span class="style3">Track Clicks for Each Job Tweet</span> </li>
                                        <li> <span class="style4">Share to LOCAL JOB RELATED GROUPS in Facebook</span> </li>
                                        
                                      </ul>
                                            <div class="pricing-footer">
											<?php if($account_data['billing_plan'] < 3): ?>
											<form name="subscribe_form2" id="subscribe_form2" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_xclick-subscriptions">
<input type="hidden" name="business" value="EBYAH4W3RXWV4">
<input type="hidden" name="lc" value="US">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="pricing hover-effect">
                                            ...
                                            <ul class="pricing-content list-unstyled">
                                                ...
                                                <li>
                                                    <span class="style4">Jobs can be added to JobAlarm.com either through Twitter or XML feed..                                                </span>                                                </li>
                                                <li>
                                                    <span class="style3">Dedicated Account Support</span>                                                </li>
                                                <li>
                                                    <span class="style4">Access to Texting Module*.</span>                                                </li>
                                                <li>
...
<?php endif; ?>
	...
	<script>
            var setPaymentPlan3 = function() {
                $.ajax({
                    url:'upgrade.php?pid=3',
                    success:function(data) {
                        $('#subscribe_form2').submit();
                    }
                });
            }
