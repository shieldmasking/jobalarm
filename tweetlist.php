						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption" data-toggle="collapse" align="center">
									<span class="caption-subject font-blue-sharp bold uppercase">Send Me More Jobs Like These! </span>
								</div>
							</div>
							<div class="form-group">
						<input type="text" class="form-control" placeholder="Enter Your Email" id="email_address" name="email_address" value="<?php echo $emailaddress;?>" />
					</div>
					<input type="hidden" name="u" value="<?php echo $username;?>" />
					<div class="form-group" align="center">
						<span class="input-group-btn" style="background:#0099FF">
						<a href="javascript:;" onClick="tj.saveSearch();" id="save_email_btn" class="btn submit" style="color:white"><span class="style2">SAVE</span></i></a></span>
						</div>
