...
$dbData = Config::get('db')->get_results("select * from account where id={$account_id}");
$nameDetails = trim($dbData[0]['fullName'].' (@'.$dbData[0]['twitter_handle'].') '.$dbData[0]['email']); 
...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed">
    ...
    <div class="page-header">
        ...
        <div class="page-header-menu" style="background-color:#444d58">
            <div class="container">
                <h1 style="width:340px;float:left;margin:0;padding:5px;color:white">Account Manager</h1>
                <!-- BEGIN MEGA MENU -->
        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="useradmin.php">Account Manager</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li class="active">
                        Billing History
                ...
                <div class="row margin-top-10">
                    <div class="col-md-12 col-sm-12">
                        <h3>Account Billing History For: <?php echo $nameDetails; ?> </h3>
                    </div>
                </div>
                <div class="row margin-top-10">
                        <!-- BEGIN PORTLET-->
...
<!--                                 <div class="table-scrollable" style="height:474px"> -->
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="portlet light tasks-widget">
                            ...
                            <div class="portlet-body">
<!--                                 <div class="table-scrollable" style="height:474px"> -->
								   <table class="table table-striped table-bordered table-hover" id="datatablespayment_ajax">
								    <thead>
								    <tr role="row" class="heading">
									    <th width="0">
										     ID
...
<![endif]-->
    ...
    <script type="text/javascript">
        var tj = tj || {};
        tj.account_id = <?php echo (isset($_REQUEST['aid']) && $account_data['role'] == 10) ? $_REQUEST['aid'] : $account_data['accountId']; ?>;
    </script>
    <script src="inc/userbilling-table.js"></script>
