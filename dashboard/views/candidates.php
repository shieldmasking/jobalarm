...
$smsUsers = Config::get('db')->get_results("select s.id, s.storeBrand FROM `sms_brand` s LEFT JOIN `account_brand` as a on a.brandId=s.id where a.accountId='{$accountId}' OR a.accountId=443 order by s.id");	
}else{
                        ...
                        <table id="candidatesTable"  class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
									...
									<th width="">Rec</th>
                                    <th width="">Zip</th>
                                    <th width=""hidden>Skills/Resume</th>
									<th width=""hidden>Resume</th>
									<th width=""hidden>Email</th>
									<th width="">Date</th>
                                 </tr>
                            </thead>
                        </table>
