...
<div class="m-content">
                ...
                <div class="m-portlet__body">
				 <div class="row">
						...
						<div class="col-sm-6">
                            <div class="pull-right">
                                <div class="order-xs-1 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="text-align:right">
                                        ...
                                        <button type="button" class="btn btn-success" data-target="#addnewLocation" data-toggle="modal">
                                            New Location
                                        </button>
                                    </div>
                                <!--end: Dropdown-->
					...
					<div class="row">
                        ...
                        <table id="locationsTable"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
    <!--                                <th></th>-->
    <!--                                <th></th>-->
                                    <th width="20%" data-priority="1">Store</th>
                                    <th width="50%" data-priority="4">Address</th>
                                    <th width="10%" data-priority="2">Candidates</th>
                                    <th width="20%" data-priority="3" hidden>Action</th>
                                </tr>
                            </thead>
                        </table>
						</div>
	...
	<!--end::Modal-->
	    <div class="modal fade" id="addnewLocation" tabindex="-1" role="basic" aria-hidden="true">
         <div class="col-sm-6">
	    ...
	    <!--begin::Modal-->
    <!--end::Modal-->
	    <div class="modal fade" id="edit_location" tabindex="-1" role="basic" aria-hidden="true">
        <div class="col-sm-5">
		<div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light">
                ...
                <div class="modal-footer">
				     <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="tj.updateLocation();">Update</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
	...
	<!--begin::Modal-->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="edit_job_form" class="m-form m-form--fit m-form--label-align-right">
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group m--margin-top-10 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input" type="text" value="" id="ecf_job_title">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
									<textarea class="form-control" rows="3" maxlength="250" placeholder="" id="ecf_job_desc"></textarea>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label for="example-search-input" class="col-2 col-form-label">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input" type="text" maxlength="5" value="" id="ecf_job_zip">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="tj.updateJob(tj.editJobTarget);">Update</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
