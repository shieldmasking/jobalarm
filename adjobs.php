...
if ( isset($_POST['email']) && isset($_POST['name']) && isset($_POST['text']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) ) {
  ...
  //send email
  mail( "info@tweetedjobs.com", "TweetedJobs Contact Form: ".$_POST['name'].$company, $_POST['name']."\r\n\r\n".$_POST['company']."\r\n\r\n".$_POST['email']."\r\n\r\n".$_POST['text'], "From: TweetedJobs ContactUs <info@tweetedjobs.com>"  );
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="index.php"><img src="img/JALogoBlue3.png" alt="logo" class="logo-default"></a>			</div>
			<!-- END LOGO -->
...
<div class="page-content">
  ...
  <div align="center"><br />
    ...
    <br />
    <strong><span class="style13 style1">Step 1:</span> Include <span class="style16 style1">#jobs</span> AND the <span class="style16 style1">City, ST</span> <br />
    (ie. Fremont, NE) when you share a job on Twitter™. </strong></span>
    <p class="style1 style11"><strong>THAT'S IT!!     
    </strong>
    <p class="style12"><strong><strong>Your job is now searchable on <span class="style16 style1">TweetedJobs.com</span> for millions of Job Seekers.    
    </strong> </strong>
    <p class="style6"><span class="style8 style6"><span class="style13 style1">Want More?:</span> Include an industry (ie. <span class="style16 style1">#Healthcare</span>) to enhance your job's searchability.</span>
	<!--<p><strong><strong><span class="style13 style1">Also,</span> Include you Job Type to help Job Seekers find your position quickly.</strong>
	</strong>
	<div align=left>
	<ul>
    <ul>
      <ul>
        <ul>
          <li><strong>For Full Time:  <span class="style16 style2">#fulltime or #ft or #perm</a></span></strong></li>
          <li><strong>For Part Time:  <span class="style16 style2">#parttime or #pt</a></span></strong></li>
          <li><strong>For Temp:  <span class="style16 style2">#temp</a></span></strong></li>
          <li><strong>For Temp to Perm: <span class="style16 style2">#temptoperm or #temp2perm or #t2p</a></span></strong></li>
          <li><strong>For Contract:  <span class="style16 style2">#contract</a></span></strong></li>
          <li><strong>For 1099:  <span class="style16 style2">#1099</a></span></strong></li>
        </ul>
        </ul>
      </ul>
    </ul> -->
						...
						<div class="row margin-bottom-20">
								...
								<div class="well">
									<h4>Address</h4>
					                    <address class="margin-bottom-40">
					                        Premier SSG, Inc.<br />
					                        2591 Dallas Parkway, Suite 300 <br />
					                        Frisco, TX 75034 <br />
					                        Email: <a href="mailto:info@tweetedjobs.com">info@tweetedjobs.com</a>                        
					                    </address>
							...
							<div class="col-md-6">
								...
								<form id="contact" action="contact.php" method="post">
									...
									<p>
										 Thank you for your interest in Tweeted Jobs. Please fill out and submit the form below. A Tweeted Jobs Rep will be in touch with you asap.
									</p>
									...
									<div class="form-group">
										<textarea id="contact_feedback" name="contact_feedback" class="form-control" rows="3=6" placeholder="Feedback"></textarea>
									</div>
