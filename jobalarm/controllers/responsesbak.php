...
class Responses {
    ...
    public static function getCandidates() {
		...
		if ($accountId==241 || $accountId==240 || $accountId==255) {
			 $search_add2 = " and (c.resume LIKE '%rest%' or c.resume LIKE '%food%' or c.resume LIKE '%cashier%' or c.resume LIKE '%cook%' or c.resume = '')";
		 }
        ...
        and (x.accountId=$accountId or (x.accountId=212$search_add2) or (x.accountId=0))
		$search_add
		group by x.id
		/*HAVING msgCount<(a.tLimit)*/
        ORDER BY {$order_by}";
