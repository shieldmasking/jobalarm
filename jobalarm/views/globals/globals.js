...
$(function () {
  ...
  $('#layout').w2layout({
    name: 'layout',
    panels: [
	{type: 'top', size: 50, style: pstyle, content: '<h1 style="float:left">Candidate Manager</h1><div class="pull-right"><button onclick="window.location=\'http://www.jobalarm.com/dashboard/index2.php\';">DASHBOARD <span class="fa fa-back"></span>  </button>&nbsp;&nbsp;&nbsp;<button onclick="window.location=\'http://admin.jobalarm.com/smsview\';">SMS INBOX <span class="fa fa-people"></span></button></div>'},
