...
$access_token			= '26564418-lXp9wi6Uxkla425phZmE4W2Tp0pTevlR33xjjftge';
$access_token_secret		= 'ZNXgDmVRxzTHwxi9HqzIwRaQ3n8xzT2TGqrXtimmlk0KG';
$consumer_key			= '3kkH7zqxgOBJTB6GCO73vNjum';
$consumer_secret		= 'IYTHCTOdCIlHns0yP3PoZJKhz3jLqNVfthHD7Y0uvbJsx57tob';

// Some variables
$twitter_username 		= 'jobs';
$number_tweets			= 20; // How many tweets to display? max 20
...
$getfield = '?q=%23'.$twitter_username;
$requestMethod = 'GET';
$settings = array(
...
if (!$twitter_debug) {
	...
	if ( (time() - $twitter_cache_time < $cache_created_on) && $twitter_caching) {
		...
		// var_dump($twitter_stream);
		// Check if at least 1 tweet returned from API
		if (isset($twitter_stream->statuses)) {
			...
			foreach ($twitter_stream->statuses as $tweet){
