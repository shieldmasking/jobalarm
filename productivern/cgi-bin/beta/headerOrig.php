                ...
                <ul class="m-menu__nav m-menu__nav--dropdown-submenu-arrow ">
                  <?php if($role >3): ?>  
					...
					<li class="m-menu__item" aria-haspopup="true">
                        <a href="#staffing" class="m-menu__link " onclick="$('#m_aside_left_close_btn').click();">
					...
					<?php if($role <4 || $userId ==32 || $userId ==123 || $userId ==1 || $accountId==2): ?>
                    <li class="m-menu__item" aria-haspopup="true">
					...
					<?php endif; ?>
					<?php if($userId ==32 || $userId ==123 || $userId ==1 || $accountId==2): ?>
                    <li class="m-menu__item" aria-haspopup="true">
                    ...
                    <form id="activate_user_form" class="m-form m-form--fit m-form--label-align-right">
						...
						<div class="m-portlet__body">
							...
							<div class="form-group" id="activateAlerts">
										...
										<label for="times" class="col-3 col-form-label">
										<strong>Alert Times:</strong>
										</label>
										<div class="col-9">
