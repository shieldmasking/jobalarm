...
$deptId = (isset($_REQUEST['i'])) ? $_REQUEST['i'] : '';

if($deptId){
	$deptdb = Config::get('db')->get_results("SELECT * from `ProductiveDept` where `id`={$dept}");
	$dbData = $deptdb[0];
}else{
exit();
}
                ...
                <div class="m-portlet__body">
				 ...
				 Unit Details</h4>
						...
						<input id="account" type="hidden" value="" />
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
                                <input type="text" id="depName" value="<?php echo $dbData['dept'];?>" required>
							</div>
                            </div>
							<div class="form-group">	
							    <label for="unitId">Number/ID  </label>
								<div class="col-xs-1">
                                <input type="text" id="unitId" value="<?php echo $dbData['unitId'];?>" required>
							</div>	
                            </div>
							<div class="form-group">	
							    <label for="totalbeds">Beds  </label>
								<div class="col-xs-1">
                                <input type="number" id="totalbeds" value="<?php echo $dbData['totalbeds'];?>" required>
							</div>	
                            </div>
				 ...
				 Productivity</h4>
                            ...
                            <label for="prodMeasure">How is your productivity measured:</label>
                             <div class="col-xs-1">   
                            <select id="prodMeasure" type="select" class="input-medium" value="<?php echo $dbData['prodMeasure'];?>" required >
							...
							<div class="form-group">
								...
								<div class="col-xs-1">
                                <input type="text" class="number" id="prodValue" value="<?php echo $dbData['hppd'];?>" required>
							</div>
                            </div>
							<div class="form-group">	
							    <label for="target">Target Productivity % </label>
								<div class="col-xs-1">
                                <input type="number" id="target" value="<?php echo $dbData['target'];?>" required>
							</div>	
                            </div>
							<div class="form-group">
                               	<label for="censusShift">What time is your census taken:</label>
                                <div class="col-xs-1">
                                    <select id="censusShift" type="select" class="input-large" value="<?php echo $dbData['shift'];?>" required >
				 ...
				 <div class="title">
				 Chose the acuity levels that you want in your reports.  Descriptions can be as simple as High, Med, Low or more specific description of patient conditions.</br>
				 </div>
				
                       
						<div class="form-group">
							<label class="form-group-label">
							<input type="checkbox" id="one2oneChecked" name="one2oneChecked" value="<?php echo $dbData['oneto1'];?>" />
							<strong> 1 to 1</strong>
							</label>
							<div class="form-group col-xs-4">
							<label for="descConfig1">Description:  </label>
							<input type="text" id="descConfig1" value="<?php echo $dbData['desc1'];?>">
							</div>
						</div>
						
						<div class="form-group">
							<label class="form-group-label">
							<input type="checkbox" id="one2twoChecked" name="one2twoChecked" value="<?php echo $dbData['oneto2'];?>" />
							<strong> 1 to 2</strong>
							</label>
							<div class="form-group col-xs-4">
							<label for="descConfig2">Description:  </label>
							<input type="text" id="descConfig2" value="<?php echo $dbData['desc2'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="form-group-label">
							<input type="checkbox" id="one2threeChecked" name="one2threeChecked" value="<?php echo $dbData['oneto3'];?>" />
							<strong> 1 to 3</strong></br>
							</label>
							<div class="form-group col-xs-4">
							<label for="descConfig3">Description:  </label>
							<input type="text" id="descConfig3" value="<?php echo $dbData['desc3'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="form-group-label">
							<input type="checkbox" id="one2fourChecked" name="one2fourChecked" value="<?php echo $dbData['oneto4'];?>" />
							<strong> 1 to 4</strong></br>
							</label>
							<div class="form-group col-xs-4">
							<label for="descConfig4">Description:  </label>
							<input type="text" id="descConfig4" value="<?php echo $dbData['desc4'];?>">
							</div>
						</div>
						<div class="form-group col-xs-4">
							<label class="form-group-label">
							<input type="checkbox" id="one2fiveChecked" name="one2fiveChecked" value="<?php echo $dbData['oneto5'];?>" />
							<strong> 1 to 5</strong></br>
							</label>
							<div class="form-group col-xs-4">
							<label for="descConfig5">Description:  </label>
							<input type="text" id="descConfig5" value="<?php echo $dbData['desc5'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="form-group-label">
							<input type="checkbox" id="one2sixChecked" name="one2sixChecked" value="<?php echo $dbData['oneto6'];?>" />
							<strong> 1 to 6</strong></br>
							</label>
							<div class="form-group col-xs-4">
							<label for="descConfig6">Description:  </label>
							<input type="text" id="descConfig6" value="<?php echo $dbData['desc6'];?>">
							</div>
						</div>
						<!--
						<div class="form-group">
