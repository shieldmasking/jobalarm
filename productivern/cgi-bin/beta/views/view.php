                    ...
                    <form id="addwhp" class="m-form m-form--fit m-form--label-align-right">
						...
						<div class="form-group" id="hiddenwhp1">
							...
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="skillwhp2" class="col-form-label" style="color:black">
						...
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="skillwhp3" class="col-form-label" style="color:black">
						...
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="skillwhp4" class="col-form-label" style="color:black">
						...
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="skillwhp5" class="col-form-label" style="color:black">
						...
						<div style="padding-left: 25px; padding-right: 20px; padding-top: 20px;">
                                <label for="totaluosWHP" class="col-form-label" style="color:black">
                                    Total UOS</label>
		...
		<!--<a href="javascript:;" onclick="tj.getprintView()">Print View</a>
			...
			-->
                ...
                <form id="newprodView" class="m-form m-form--fit m-form--label-align-right">
						...
						<div class="title" id="inshiftview"><h5>Est. Productivity: <span id="prodView"></span>%</h5>
						</div>
						...
						<div class="form-group">
                                <div style="padding-left: 25px; padding-right: 20px;">
								<label for="chargecountView" class="col-form-label" style="color:black">
                                   Charge Nurses
                                </label>
						  ...
						  <div class="form-group" id="customcount">
                                <div style="padding-left: 25px; padding-right: 20px;">
								<label for="customcountView" class="col-form-label" style="color:black">
                                   <span id="customcountTitle"></span>
                                </label>
                                
                                    <input id="customcountView" name="customcountView" type="text" class="form-control" disabled>
                                </div>
                          </div>
							
							<div class="form-group">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="techcountView" class="col-form-label" style="color:black">
                                   Techs
                                </label>
						...
						<div class="form-group">
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="seccountView" class="col-form-label" style="color:black">
                                   Secretaries
                                </label>
						 ...
						 <div class="form-group">
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="nursecountView" class="col-form-label" style="color:black">
                                    Nurses
                                </label>
						  ...
						  <div class="form-group">
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="otherView" class="col-form-label" style="color:black">
						...
						<div class="form-group">
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="totalpatientsView" class="col-form-label">
                                    Total                                
									</label>
							...
							<div class="form-group" id="hidden1view">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="one2oneView" class="col-form-label" style="color:black">
							...
							<div class="form-group" id="hidden2view">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="one2twoView" class="col-form-label" style="color:black">
							...
							<div class="form-group" id="hidden3view">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="one2threeView" class="col-form-label" style="color:black">
							...
							<div class="form-group" id="hidden4view">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="one2fourView" class="col-form-label" style="color:black">
							...
							<div class="form-group" id="hidden5view">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="one2fiveView" class="col-form-label" style="color:black">
							...
							<div class="form-group" id="hidden6view">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="one2sixView" class="col-form-label" style="color:black">
							...
							<div class="form-group" id="hidden7view">
							<div style="padding-left: 25px; padding-right: 20px; padding-top: 20px;">
                                <label for="one2sevenView" class="col-form-label" style="color:black">
                                    <span id="descView7"></span>
                                </label>
                                
                                    <input id="one2sevenView" name="one2sevenView" type="text" class="form-control" disabled>
                                </div>
                            </div>
							<div class="form-group" id="hidden8view">
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="one2sevenView" class="col-form-label" style="color:black">
                                    <span id="descView8"></span>
                                </label>
                                
                                    <input id="one2eightView" name="one2eightView" type="text" class="form-control" disabled>
                                </div>
                            </div>
						...
						<div class="form-group">
						<div style="padding-left: 25px; padding-right: 20px; padding-top: 20px;">
                                <label for="admissionsView" class="col-form-label" style="color:black">
                                    Admissions</label>
						  ...
						  <div class="form-group">
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="transfersView" class="col-form-label" style="color:black">
                                    Transfers</label>
						  ...
						  <div class="form-group">
						<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="dischargesView" class="col-form-label" style="color:black">
                                    Discharges</label>
							...
							<div class="form-group">
							<div style="padding-left: 25px; padding-bottom: 20px; padding-right: 20px;">
                                <label for="prodnoteView" class="col-form-label" style="color:black">Variance Note / Action Plan</label>
