...
<div class="m-content">
	...
	<input id="endStaff" type="hidden" value="<?php echo $endPay; ?>" />
	    ...
	    <div class="row pull-right" <?php echo $hidden; ?>> 
				...
				<button type="button" class="btn btn-danger" data-target="#addEscalation3" data-toggle="modal" <?php echo $hidden; ?>>
                Escalation
                </button> 
                        ...
                        <table id="prodTable"  class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%" style="color:black">
                            <thead>
                                <tr>
									...
									<th width="35%" data-priority="5">Note</th>
                                </tr>
                            </thead>
                        </table>
			</div>
		...
		<div class="modal-dialog modal-lg">
			...
			<div style="background-color:#0099FF">
				...
				<div class="row">
					...
					<div class="form-group m-form__group m--margin-top-10 row" id="visit">
                                <label for="visits" class="col-7 col-form-label">
                                    Daily Visits:
                                </label>
                                <div class="col-5">
								<input type="number" min="0" class="form-control number" id="visits" style="text-align: right" />
                                </div>
								<hr></hr>
                            </div>
