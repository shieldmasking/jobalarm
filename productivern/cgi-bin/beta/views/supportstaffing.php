...
<div class="m-subheader bg-light" style="padding-bottom: 30px;">
	...
	<input id="supportRole" type="hidden" value="<?php echo $role; ?>" />
	<input id="supportTitle" type="hidden"/>
            ...
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__body">
				 <div class="row pull-right" <?php echo $hidden; ?>>
				     <button type="button" id="escButtonwhp" class="btn btn-danger" data-target="#addEscalation3whp" data-toggle="modal">
                                            Escalation
                                        </button>                         
					 </div>
                             <!--end: Dropdown-->
