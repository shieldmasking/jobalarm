        ...
        <div class="page-header-menu" style="background-color: #282A3C">
            <div class="container">
                <a href="https://www.perfectshift.com">
                        <img src="../img/perfectlogin.png" alt="logo" class="logo-default" />
                    </a>
                <!-- BEGIN MEGA MENU -->
