...
if ( isset($_POST['email']) && isset($_POST['name']) && isset($_POST['text']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) ) {
  ...
  //send email
  mail( "rstrenger@productivern.com", "ProductiveRN Contact Form: ".$_POST['name'].$company, $_POST['name']."\r\n\r\n".$_POST['company']."\r\n\r\n".$_POST['email']."\r\n\r\n".$_POST['mobile']."\r\n\r\n".$_POST['text'], "From: ProductiveRN ContactUs <rstrenger@productivern.com>"  );
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-125801493-3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-125801493-3');
</script>
<meta charset="utf-8"/>
<title>ProductiveRN | Contact Us</title>
						...
						<div class="row margin-bottom-20">
								...
								<div class="well">
									<h4>Address</h4>
					                    <address class="margin-bottom-40">
					                        ...
					                        Frisco, TX 75034 <br />
											Email: <a href="mailto:rstrenger@jobalarm.com">info@productivern.com</a><br /> 
											Phone: 855-603-7073                      
					                    </address>
							...
							<div class="col-md-6">
								...
								<form id="contact" action="contact.php" method="post">
									...
									<p>
										 Thank you for your interest in ProductiveRN. Please fill out the form below and a ProductiveRN Rep will be in touch with you asap.
									</p>
...
<div class="page-footer">
	<div class="container">
		 2017 &copy; Harrelson Group LLC. All Rights Reserved.
	</div>
</div>
