...
<div class="page-content">
	<div class="container">
		...
		<div class="portlet light">
            ...
            <div class="content">
                <div class="title">
				<a href="dashboard.php#staffing">Back</a>
				</div>
				...
				<div class="row" style="margin-top:5px;margin-bottom:8px">
                    ...
                    <form id="addSICU" class="m-form m-form--fit m-form--label-align-right">
						...
						<div class="form-group">
								...
								<label for="chargecountSICU">
                                   Charge Nurses
                                    ...
                                    <input id="chargecountSICU" name="chargecountSICU" type="text" class="form-control" value="<?php echo $account_data['chargecount']; ?>" disabled>
                                </div>
                          </div>
						...
						<div style="padding-left: 25px; padding-right: 20px; padding-top: 20px;">
							...
							<div style="padding-left: 25px; padding-right: 20px;">
                                <label for="lowSICU">
                                    1:4 Acuity Patients (<?php echo $account_data['desc5']; ?>)
                                </label>
