...
<div class="container" align="center">
                <a href="https://www.millwoodassociates.com">
                        <img src="../img/millwoodLogin.png" alt="logo" class="logo-default" />
                    </a>
            </div>
    ...
    <div class="content">
	    ...
	    <form class="login-form" action="index.php" method="post">
		    ...
		    <div class="form-actions">
			    ...
			    -->
				<a href="" id="forget-password" onclick="" data-toggle="modal" data-target="#forgot">Forgot Password?</a>
		    </div>
			</form>
			</div>
			<div class="container">
