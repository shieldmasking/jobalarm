...
.'<p>' . $data4[0]['accountName'] . ' Daily Compliance Reporting ('. $data4[0]['reportDate'] .')</p><br><img src="cid:'. substr($data4[0]['accountName'],0,3).'Image">';
