...
if(intval($data2[0]['houseLogins'])==1 && strlen($logix)>8){
$mail->Body    = '<p><a href="https://www.productivern.com/logix.php?m=' . $logix . '">LOGIN HERE</a></p>'
.'<p>' . $data2[0]['accountName'] . ' Daily Compliance Reporting ('. $data2[0]['reportdate'] .')</p>'
.'<p>House Logins: '. $data2[0]['houseCount'] . '</p></br>'
.'<img src="cid:'. substr($data2[0]['accountName'],0,3).'Image">';
}else if(intval($data2[0]['houseLogins'])==1 && strlen($logix)==0){
...
$mail->Body    = '<p><a href="https://www.productivern.com/' . $login . '">LOGIN HERE</a></p>'
.'<p>' . $data2[0]['accountName'] . ' Daily Compliance Reporting ('. $data2[0]['reportdate'] .')</p></br>'
.'<img src="cid:'. substr($data2[0]['accountName'],0,3).'Image">';
}
