...
$brData = Config::get('db') -> get_results("SELECT s.*, a.status as acctStatus, a.fullName, a.logo, a.logopic, a.rolex as atype, c.mobile from `sms_brand` s left join `account` as a on a.id ={$accountId} left join `candidate` as c on c.mobile = {$candidateId} where s.id ={$brandOrig}");
...
//$zip = ($accountData['zip']) ? $accountData['zip'] : '';
				...
				<div class="row">
						  <div class="col-md-12">
								...
								<?php } ?>	
									...
									<?php }else{ ?>	
									<p class="auto-style3">You are just a few steps away from submitting your application with <?php echo $franchise; ?>. </p>
									<?php } ?>	
									<!--<p class="auto-style3">  
