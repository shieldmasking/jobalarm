...
$upload = intval($_SESSION['account']['jobsUpload']);
$smsSend = intval($_SESSION['account']['smsSend']);

if(intval($upload)==0){
$jobsupload = "Download a .csv example <a href=\"/feeds/uploads/JobAlarmUploadTemplate.csv\" download>here</a>, or contact your JobAlarm Representative to setup a custom solution.";
}else{
$jobsupload = "Download your last job file <a href=\"/feeds/uploads/" . $accountId . ".csv\" download>here</a> to use as a template, or contact your JobAlarm Representative to setup a custom solution.";	
}

$dbData = Config::get('db')->get_results("select s.* from `sms_brand` s inner join `account_brand` as b on b.brandId=s.id and b.accountId ={$accountId}");
if ($dbData){
$brandType = intval($dbData[0]['type']);
}else{
$brandType = 1;
}
...
<!--                                                        </li>-->
                                                        ...
                                                        <li class="m-nav__item">
														 <a href="#uploadModal" id="fileUpload" data-toggle="modal">
    ...
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
        ...
        <div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
            ...
            <div
                ...
                <ul class="m-menu__nav m-menu__nav--dropdown-submenu-arrow ">
					...
					<?php if($role >=2 && $acctType !=6){ ?>
                    <li class="m-menu__item" aria-haspopup="true">
					<?php }else{ ?>
					<li class="m-menu__item" aria-haspopup="true" hidden>
					<?php }; ?>
					
                        <a href="#locations" class="m-menu__link ">
					...
					<li class="m-menu__item" aria-haspopup="true" hidden>
					<?php }; ?>
                        <a href="#candidates" class="m-menu__link ">
					...
					<li class="m-menu__item" aria-haspopup="true" >
					<?php }; ?>
                        <a href="#smsinbox" class="m-menu__link ">
					...
					<!--
                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="#recruiter" class="m-menu__link ">
                            <i class="m-menu__link-icon flaticon-chat"></i>
                            <span class="m-menu__link-title">
                                <span class="m-menu__link-wrap">
                                    <span class="m-menu__link-text">
                                        Mobile Recuiter (beta)
                                    </span>
                                </span>
                            </span>
                        </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="form-group"><button onclick="tj.submitSupport()" class="btn btn-success pull-left">Send</button> <p class="help-block pull-left text-danger hide" id="form-error"></p> &nbsp;&nbsp;<button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
                    </div>
                </div>
            </div>
            <!-- /.modal-content -->
	...
	<div class="modal fade" id="uploadModal" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-light">
				<h2 class="modal-title">The Job File must be in a .csv format.</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                ...
                <div class="modal-footer">
				<div class="form-group">
				<button type="button" onclick="tj.uploadjobs();" name="uploadButton" class="btn btn-success pull-left">Upload</button> <p class="help-block pull-left text-danger hide" id="form-error"></p> &nbsp;&nbsp;
