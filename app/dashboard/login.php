...
if (isset($_POST['sitelogin'])) {
	...
	$query = "SELECT u.*, a.billing_plan, a.jobsUpload, a.email as mail, a.password as pw, a.twitter_handle, a.twitter_key, a.status, a.twitter_passcode, a.logo FROM users u LEFT JOIN account as a on a.id = u.accountId WHERE u.email='{$email}' AND u.password='{$password}'";
...
<footer class="page-footer" align="center">
	...
	<div align="center">2017 &copy; Harrelson Group LLC. All Rights Reserved.  <a href="privacy.html" target="_blank">  Privacy Policy</a> | <a href="/terms/index.html" target="_blank">  Terms of Use</a></div>
