...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed">
    ...
    <div class="page-header">
        ...
        <div class="page-header-menu" style="background-color:#444d58">
            <div class="container">
                <h1 style="width:340px;float:left;margin:0;padding:5px;color:white">Promo Codes</h1>
                <!-- BEGIN MEGA MENU -->
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject theme-font bold uppercase">Promo Codes</span>
                                </div>
                            </div>
                            <div class="portlet-body" id="accounteditbox">
                                <table class="table table-striped table-bordered table-hover" id="datatableaccount_ajax">
								    <thead>
...
<![endif]-->
    ...
    <script src="inc/couponcodes-table.js"></script>
    <script type="text/javascript" src="theme/assets/global/plugins/jquery.bootstrap-duallistbox.js"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script src="inc/tweetedjobs-admin-coupons.js" type="text/javascript"></script>
<!--     <script>
