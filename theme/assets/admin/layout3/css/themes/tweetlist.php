...
$query = "SELECT * FROM job WHERE status=1 order by postDate desc LIMIT 0,50 ";
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="index.htm"><img src="img/logo1.png" alt="logo" class="logo-default"></a>
			</div>
			<!-- END LOGO -->
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Search Job Tweets <small></small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption" data-toggle="collapse" data-target=".todo-project-list-content">
									<span class="caption-subject font-green-sharp bold uppercase">INDUSTRIES </span>
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="caption-helper">INDUSTRY:</span> &nbsp; <span class="caption-subject font-green-sharp bold uppercase">#Jobs</span>
								</div>
<!-- 								<div class="actions">
									<div class="btn-group">
							...
							<div class="portlet-body">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="scroller" style="" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
<?php
foreach($dbData as $tweet) {
	$rawData = json_decode($tweet['rawData'],true);
	$user = $rawData['user'];
	$time = strtotime($tweet['postDate']);
											...
											<div class="todo-tasklist">
												<div class="todo-tasklist-item todo-tasklist-item-border-green">
													...
													<div class="todo-tasklist-item-title">
														 <?php echo (isset($user['screen_name'])) ? $user['screen_name'] : ''; ?>
													</div>
													...
													<div class="todo-tasklist-controls pull-left">
														...
														?>
														<span class="todo-tasklist-badge badge badge-roundless"><a target="_blank" href="https://twitter.com/hashtag/<?php echo $hashtag; ?>">#<?php echo $hashtag; ?></a></span>
														<?php
															endforeach;
														?>
													</div>
...
<script src="theme/assets/global/plugins/bootstrtheme/bootstrap.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="theme/assets/global/plugins/bootstrap-datepicktheme/bootstrap-datepicker.js"></script>
