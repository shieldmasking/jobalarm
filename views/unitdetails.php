...
<div class="m-content">
						...
						<div class="col-sm-6">
							<div class="pull-right">
								<div class="order-xs-1 col-sm-6 col-md-6 col-lg-6 col-xl-6" style="text-align:right">
                                        ...
                                        <button type="button" class="btn btn-success" data-target="#archive" data-toggle="modal">
                                            Archive Unit
                                        </button>                         
					 </div>
                                <!--end: Dropdown-->
    ...
    <div class="row">
                <div class="title">
				 ...
				 <h4>Unit Details</h4>
                           	...
                           	<div class="form-group">
                                <label for="editunitNameMgr" class="col-4 col-form-label">
                                    Unit Name:
                                </label>
                                <div class="col-8">
                            ...
                            <div class="form-group">
                                <label for="editunitNumberMgr" class="col-4 col-form-label">
                                    Unit ID/Number:
                                </label>
                                <div class="col-4">
							...
							<div class="form-group">
                               	<label for="unitManagerMgr" class="col-4 col-form-label">Manager:    <span id="currentManagerMgr"></span></label>
							...
							<div class="form-group">
                               	<label for="unitDirector" class="col-4 col-form-label">Director:    <span id="currentDirector"></span></label>
							...
							<div class="form-group">
                                <label for="editunitprodMeasureMgr" class="col-4 col-form-label">
							...
							<div class="form-group" hidden>
							    <label for="editunitTargetMgr" class="col-4 col-form-label">Productivity Target %:</label>
								<div class="col-8">
                                <input type="number" class="form-control number" id="editunitTargetMgr" required>
							</div>
                            </div>
							<div class="form-group">
							    <label for="editunitprodValueMgr" class="col-4 col-form-label">HPPD/WHPUOS Value:</label>
								<div class="col-4">
                                <input type="number" class="form-control number" id="editunitprodValueMgr">
							</div>
                            </div>
							<div class="form-group" id="uosDescription">
							    <label for="editunituosDescMgr" class="col-4 col-form-label">Unit of Service Description:</label>
								<div class="col-4">
                                <input type="text" class="form-control number" id="editunituosDescMgr">
							</div>
                           	<label for="serviceLine" class="col-4 col-form-label">Service Line:    <span id="currentDirector"></span></label>
                                <div class="col-8" id="unitdir">
                                    <select id="unitDirector" type="select" class="form-control" >
							...
							<div class="form-group">
							<label for="thresholdHigh" class="col-4 col-form-label">High Indicator Value:</label>
								<div class="col-4">
                                <input type="number" class="form-control number" id="thresholdHigh">
							</div>
							<label for="thresholdLow" class="col-4 col-form-label">Low Indicator Value:</label>
								<div class="col-4">
                                <input type="number" class="form-control number" id="thresholdLow">
							</div>
                            </div>
							<div class="form-group" id="budget">
							    <label for="budgetMeasure" class="col-4 col-form-label">Use Budget Values:</label>
								<div class="col-8">
							...
							<div class="form-group">
							    <label for="budgetValue" class="col-4 col-form-label">Daily Budget Value($):</label>
								<div class="col-4">
                                <input type="number" class="form-control number" id="budgetValue">
							</div>
							</div>
							<div class="form-group" id="whp1">
							    <label for="editunitBedsMgr" class="col-4 col-form-label">Bed Count:</label>
								<div class="col-8">
                                <input type="number" class="form-control number" id="editunitBedsMgr" required>
							</div>
                            </div>
							<div class="form-group" id="whp2">
                               	<label for="editcensusShiftMgr" class="col-4 col-form-label">Census Time:</label>
                                <div class="col-8">
						 ...
						 <div class="form-group" id="nurse2">
                               	<label for="shiftsDay" class="col-4 col-form-label">Reporting Shifts Per Day:</label>
                                <div class="col-8">
						 ...
						 <div class="form-group">
                                <label for="addEscalations" class="col-4 col-form-label">
							...
							<div id="whp">
						 <div class="form-group">
							    <label for="churn" class="col-4 col-form-label">Show Churn:</label>
								<div class="col-8">
				 ...
				 <p>Select the Acuity Levels appropriate for your Unit.  Descriptions can be as simple as High, Med, Low or more specific for each Acuity Level.</p>
						...
						<div class="form-group">
							...
							<div>
							<label for="descConfig1Mgr" class="col-6 col-form-label">Description:
						...
						<div class="form-group">
							...
							<div>
							<label for="descConfig2Mgr" class="col-6 col-form-label">Description: 
						...
						<div class="form-group">
							...
							<div>
							<label for="descConfig3Mgr" class="col-6 col-form-label">Description:
						...
						<div class="form-group">
							...
							<div>
							<label for="descConfig4Mgr" class="col-6 col-form-label">Description:
						...
						<div class="form-group">
							...
							<div>
							<label for="descConfig5Mgr" class="col-6 col-form-label">Description:
						...
						<div class="form-group">
							...
							<div>
							<label for="descConfig6Mgr" class="col-6 col-form-label">Description:  
				...
				<div id="skill">
				 ...
				 <div class="title">
				 <p>Define up to 5 Resources for WHPUOS calculation.  Default is one field labeled "Hours of Service".</p>
				 </div>
						...
						<div class="form-group">
							...
							<div>
							<label for="skilldesc1" class="col-6 col-form-label">Description:
							
							<input type="text" id="skilldesc1" class="form-control">
							</label>
							<label for="skillbudget1" class="col-6 col-form-label">Budget Value($):
						...
						<div class="form-group">
							...
							<div>
							<label for="skilldesc2" class="col-6 col-form-label">Description: 
							<input type="text" id="skilldesc2" class="form-control">
							</label>
							<label for="skillbudget2" class="col-6 col-form-label">Budget Value($):
						...
						<div class="form-group">
							...
							<div>
							<label for="skilldesc3" class="col-6 col-form-label">Description:
							<input type="text" id="skilldesc3" class="form-control">
							</label>
							<label for="skillbudget3" class="col-6 col-form-label">Budget Value($):
						...
						<div class="form-group">
							...
							<div>
							<label for="skilldesc4" class="col-6 col-form-label">Description:
							<input type="text" id="skilldesc4" class="form-control">
							</label>
							<label for="skillbudget4" class="col-6 col-form-label">Budget Value($):
						...
						<div class="form-group">
							...
							<div>
							<label for="skilldesc5" class="col-6 col-form-label">Description:
							<input type="text" id="skilldesc5" class="form-control">
							</label>
							<label for="skillbudget5" class="col-6 col-form-label">Budget Value($):
                   ...
                   <div class="title"><h4>Additional Productive Resources</h4>
				  </div>
				...
				<hr></hr>
				 ...
				 <div class="title">
				 <p>These are resources that you have granted temporary access for this Unit (ie. Charge Nurse coming over from another unit or a Manager backing you up for vacation).</p>
				 </div>
				  <div>
				...
				<div class="pull-right">
                    ...
                    <button type="button" class="btn btn-primary" onclick="tj.updateUnitMgr();">Save Changes</button>
                </div>
            <!-- /.modal-content -->
        </div>
		</div>
