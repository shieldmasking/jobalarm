        ...
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__body">
				 ...
				 <div class="pull-right" <?php echo $hidden; ?>>
                        ...
                        <table id="prodTablewhp"  class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%" style="color:black">
                            <thead>
                                <tr>
									...
									<th width="10%" data-priority="4">Actual WHPUOS</th>
									<th width="10%" data-priority="6">Hours Variance</th>
									<th width="10%" data-priority="7">Units of Service</th>
									<th width="10%" data-priority="8">Total Hours</th>
									...
									<th width="20%" data-priority="5">Note</th>
                                </tr>
                            </thead>
                        </table>
						</div>
