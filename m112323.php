...
foreach($jobsList as $tweet) {
	...
	if ($searchAdd){
		$moreLike = '<a href="http://www.jobalarm.biz/m1.php?z='.$zipcode.'&a='.$acctAdd.'&m='.$candidateId.'&b='.$brandOrig.'">Back</a>';
	}else{
		$moreLike = '<a href="http://www.jobalarm.biz/m1.php?z='.$zipcode.'&a='.$acctAdd.'&m='.$candidateId.'&b='.$brandOrig.'&s='.$moreSearch.'&p='.$morePriority.'">More jobs like this one</a>';
	}
