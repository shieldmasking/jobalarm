    ...
    if ($_GET['pid'] > 0 && $_GET['pid'] < 4) {
        ...
        if ($_GET['pid'] == 2) {
            ...
            $data = array(
                ...
                'name'=>'Small Business (2 Sponsored Jobs',
            ...
            $data = array(
                'account_id'=>$_SESSION['account']['id'],
                'name'=>'Advanced Business (10 Sponsored Jobs)',
                'start_date'=>date('Y-m-d H:i:s'),
                'end_date'=>date('Y-m-d H:i:s',strtotime("+30 days")),
                'limited'=>1,
                'click_budget'=>'5.00',
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light">
                            ...
                            <div class="portlet-title">
                                ...
                                <a class="btn blue pull-right margin-top-10" href="dashboard.php"> <i class="fa fa-backward"></i>Back</a>
                            </div>
...
<?php if (!$billing_hold): ?>
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <div class="pricing-head pricing-head-active">
                                                <h3>
                                                    FREE
                                                    <span>
                                                        Unlimited Job Tweets &amp; <br>Organic Clicks                                                    </span>                                                </h3>
											  <span class="font-lg style1"> <strong> <i>P<span class="style6">ay-Per-Click Sponsorship Available</span></i> </strong> </span></div>
                                            <ul class="pricing-content list-unstyled">
                                                
                                                <li>
                                                    <span class="style3">JobAlarm will automatically add most job Tweets* to our site as long as they contain #jobs and City, ST (in that format).                                                </span>
                                                </li>
                                                <li>
                                                    <span class="style3">Add an Industry such as #insurance or #banking to improve your Job Tweets searchability.</span>
                                                </li>
                                                <li>
                                                    <span class="style3">Job will remain on our site for 30 days after the last time it is tweeted.</span>
                                                </li>
                                                <li>
                                                    <span class="style3">Clicks will be directed to your job.  Candidates cannot apply on Tweeted Jobs.</span>
                                                </li>
											...
											<p class="style3">
                                                    *We reserve the right to block and/or remove any job tweet from JobAlarm.com at our discretion.</p>
                                  ...
                                  <div class="col-md-4">
                                    <div class="pricing hover-effect">
                                        ...
                                        <h3> Small Business <span> 2 Sponsored Job Slots <br />
                                          Unlimited Sponsored Clicks </span> </h3>
                                        <span class="font-lg style1"> <strong> <i>$29.00 per month</i> </strong> </span> </div>
                                      <ul class="pricing-content list-unstyled">
                                        <li> <span class="style3">Includes 2 Sponsored Job Slots</span> </li>
                                      ...
                                      <div class="pricing-footer">
                                        <p></p>
										<form name="subscribe_form" id="subscribe_form" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                          <input type="hidden" name="cmd" value="_xclick-subscriptions" />
                                          <input type="hidden" name="business" value="EBYAH4W3RXWV4" />
                                          <input type="hidden" name="lc" value="US" />
                                          <input type="hidden" name="item_name" value="JobAlarm Small Business Monthly Subscription" />
                                          <input type="hidden" name="item_number" value="tjmp" />
                                          <input type="hidden" name="no_note" value="1" />
                                          <input type="hidden" name="no_shipping" value="1" />
                                          <input type="hidden" name="rm" value="1" />
                                          <input type="hidden" name="return" value="http://www.jobalarm.com/dashboard.php?complete=<?php echo $_SESSION['account']['id'];  ?>" />
                                          <input type="hidden" name="cancel_return" value="http://www.jobalarm.com/chooseplan.php?cancel=<?php echo $_SESSION['account']['id'];  ?>" />
                                          ...
                                          <a href="javascript:;" onClick="setPaymentPlan();" class="btn btn-primary"> Upgrade <i class="m-icon-swapright m-icon-white"></i> </a> <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1" />
                                        </form> 
                                        ...
                                        <div class="pricing hover-effect">
                                            ...
                                            <div class="pricing-head">
                                                ...
                                                <h3>Advanced Business <span>
                                                    10 Sponsored Job Slots
                                                    <br />
                                                        Unlimited Sponsored Clicks
                                                    </span>
                                              </h3>
											  <span class="font-lg style1"> <strong> <i>$89.00 per month</i> </strong> </span>

                                            </div>
                                            <ul class="pricing-content list-unstyled">
                                        <li> <span class="style3">Includes 10 Sponsored Job Slots</span> </li>
                                        <li> <span class="style3"> Sponsor Placement In Top  Page of Search Results (when available) </span> </li>
                                        <li> <span class="style3">Unlimited Sponsored Clicks </span> </li>
                                        <li> <span class="style3">Ability to interchange Job Tweets at any time</span> </li>
                                        <li> <span class="style3">Track Clicks for Each Job Tweet</span> </li>
...
<input type="hidden" name="business" value="EBYAH4W3RXWV4">
<input type="hidden" name="lc" value="US">
<input type="hidden" name="item_name" value="JobAlarm Advanced Business Subscription">
<input type="hidden" name="no_note" value="1">
<input type="hidden" name="no_shipping" value="1">
<input type="hidden" name="rm" value="1">
<input type="hidden" name="return" value="http://www.jobalarm.com/dashboard.php">
<input type="hidden" name="cancel_return" value="http://www.jobalarm.com/chooseplan.php">
<input type="hidden" name="src" value="1">
...
<input type="hidden" name="notify_url" value="https://jobalarm.com/payment.php" />
<input type="hidden" id="paypal_custom" name="custom" value="<?php echo $_SESSION['account']['id']; ?>" />
<a href="javascript:;" onClick="setPaymentPlan3();" class="btn btn-primary"> Upgrade <i class="m-icon-swapright m-icon-white"></i> </a> <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1" />
                                        </form>
 
                                            </div><p>For Enterprise Plans, please <a href="contact.php">contact</a> us.</p>
</div>
                                    </div>
									</div>
...
<?php endif; ?>
<?php if ($billing_hold): ?>
                                    <h1 align="center" class="font-lg font-lg style5"> Your account payment is currently processing.<br />It can take up to a couple of minutes.<br />Please try refreshing your browser or logging in again later.</h1>
<?php endif; ?>
                          </div>
    ...
    <div class="page-footer">
        ...
        <div class="container">
            ...
            <div align="center">
                2015 &copy; Tweeted Jobs. All Rights Reserved.
                <br />
