			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
						<li><a href="../howitworks/index.html">How JobAlarm Works</a></li>
                            <li><a href="http://www.innovarmediasolutions.com/who.php" target="_blank">About Us</a></li>
