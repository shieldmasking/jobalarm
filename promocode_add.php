...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed">
    ...
    <div class="page-header">
        ...
        <div class="page-header-menu" style="background-color:#444d58">
            <div class="container">
                <h1 style="width:340px;float:left;margin:0;padding:5px;color:white">Add Promo Code</h1>
                <!-- BEGIN MEGA MENU -->
				...
				<div class="col-md-12">
					<div class="portlet light" id="form_wizard_1">
						...
						<div class="portlet-body form">
                            <form action="javascript:;" id="add_promocode_form" class="form-horizontal form-row-seperated">
								<div class="form-wizard">
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
										        <div class="form-group">
											        <label class="col-md-4 control-label">Promo Code Name <span class="required" aria-required="true"> * </span></label>
											        <div class="col-md-5">
												        <input class="form-control" id="promocode_name" name="promocode_name" placeholder="" type="text" />
                                                        <span id="error_promocode_name"></span>
											        </div>
										        </div>
										        <div class="form-group">
											        <label class="col-md-4 control-label">Description</label>
											        <div class="col-md-5">
												        <input class="form-control" id="promocode_desc" name="promocode_desc" placeholder="" type="text" />
                                                        <span id="error_promocode_desc"></span>
											        </div>
										        </div>
										        <div class="form-group">
											        <label class="col-md-4 control-label">Expiration Date <span class="required" aria-required="true"> * </span></label>
											        <div class="col-md-5">
                                                        <div class="input-group" id="datepicker"  data-date-format="mm/dd/yyyy" data-date-start-date="+0d"> 
											                <div class="input-group input-large">
												                <input type="text" class="form-control" id="promocode_to" name="promocode_to" />
											                </div>                    
                                                             <span id="error_promocode_to"></span>
                                                         </div>
											        </div>
										        </div>
                                            </div>											
                                    ...
                                    <div class="row">
										<div class="pull-right" style="padding-top:20px;padding-right:20px">
											...
											Save Promo Code <i class="m-icon-swapright m-icon-white"></i>
											</a>
										</div>
									</div>
                                </div>
...
<![endif]-->
    ...
    <script src="inc/tweetedjobs-promocode-add.js" type="text/javascript"></script>
