...
$sqlAdd = '';
$kwdMsg = '';
if (strlen(trim($keywords)) == 0) { $sqlAdd = ' AND 2=1 '; $kwdMsg = '<h3>You must enter a keyword in order to search Jobs.</h3>'; }
...
//echo addslashes("(".implode(') | (',$citiesarray).")");
echo explode(',', $citiesarray);

//echo implode($glue, $citiesarray);
//GET INDUSTRIES WITHOUT SPHINXQL
//
//
//keyword condition
/*$indQuery = "select id as i_id, name as i_name, count(*) as i_count from job where 1=1 ";


if (strlen($kwdquery) > 0) {        
   $indQuery .= 'and tweet like "%'.$$kwdquery.'%" ';
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="index.php"><img src="img/logo1.png" alt="logo" class="logo-default"></a>
			</div>
			<!-- END LOGO -->
