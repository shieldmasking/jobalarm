...
<head>
    <meta charset="utf-8" />
    <title>TweetJobs | FB Groups Admin</title>
        ...
        <div class="page-content">
            <div class="container">
                ...
                <div class="row margin-top-10">
                    <div class="col-md-12" id="leftSection">
  						<table class="table table-striped table-bordered table-hover" id="datatableFacebook_ajax">								    <thead>								    <tr role="row" class="heading">									    <th>										     User Name									    </th>									    <th>										     Post Date									    </th>									    									    <th>										     Text									    </th>									    									    <th>										     Click Count									    </th>									    									    <th>										     Groups									    </th>									    									    <th>										     Manage									    </th>									    									                                            									    								    </tr>								    								    </thead>								    <tbody id="fbTweetBody">										<!-- <tr>											<td>												1											</td>											<td>												Test Group											</td>											<td>												Coppell											</td>											<td>												TX											</td>											<td>												test; key; words; go; here;											</td>											<td>												<a class="btn btn-sm blue" >Join <i class="fa fa-gears"></i></a>												<a class="btn btn-sm yellow" >Pending <i class="fa fa-gears"></i></a>												<a class="btn btn-sm green" >Post <i class="fa fa-gears"></i></a>												<a class="btn btn-sm purple" >Posted <i class="fa fa-gears"></i></a>											</td>										</tr> -->								    </tbody>								    </table>                       
                    </div>                    
...
<![endif]-->
    ...
    <script src="inc/tweetedJobsGroupUser.js" type="text/javascript"></script>
    <!-- END JAVASCRIPTS -->
</body>
<!-- END BODY -->
</html>