...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-sidebar-closed">
    ...
    <div class="page-header">
        ...
        <div class="page-header-menu" style="background-color:#444d58">
            <div class="container">
                <h1 style="width:340px;float:left;margin:0;padding:5px;color:white">Add Campaign</h1>
                <!-- BEGIN MEGA MENU -->
					...
					<div class="portlet light" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								...
								Campaign Wizard - <span class="step-title">Step 1 of 2 </span>
								</span>
							</div>
						</div>
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
										        ...
										        <div class="form-group">
											        ...
											        <div class="col-md-5">
                                                        <div class="input-daterange" id="datepicker"  data-date-format="mm/dd/yyyy" data-date-start-date="+0d"> 
										        ...
										        <div class="form-group">
											        <label class="col-md-4 control-label">Per-Click Budget (minimum $0.20)<span class="required" aria-required="true"> * </span><br />(Recommended $0.60-$1.00)&nbsp;&nbsp;&nbsp;</label>
											        <div class="col-md-5">
                                                        <div class="input-group">
											                <span class="input-group-addon">
											                <i class="fa fa-dollar"></i>
...
<![endif]-->
    ...
    <script src="inc/form-wizard.js"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script src="inc/tweetedjobs-campaign-add.js" type="text/javascript"></script>
