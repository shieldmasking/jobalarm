...
$edit_couponId = isset($_GET['pcid']) ? $_GET['pcid'] : false;
if (!$edit_couponId) {
...
//    FROM campaign WHERE /*account_id={$account_data['id']} and */ id={$edit_campaignId} and status > 0";    
					...
					<div class="portlet light" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								...
								Edit Campaign Wizard - <span class="step-title">Step 1 of 2 </span>
								</span>
							</div>
						</div>
									...
									<div class="form-body" style="padding-bottom:20px;">												
										<ul class="nav nav-pills nav-justified steps">
											<li>
												...
												1 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Campaign Setup </span>
												</a>
											</li>
											<li>
												...
												2 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Campaign Tweets </span>
												</a>
											</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
										        <div class="form-group">
											        ...
											        <div class="col-md-5">
												        <input class="form-control" id="campaign_name" name="campaign_name" placeholder="" readonly="true" value="<?php echo $campaign['edit_campaign_name']; ?>" type="text" />
										        ...
										        <div class="form-group">
											        ...
											        <div class="col-md-5">
                                                        <div class="input-daterange" id="datepicker"  data-date-format="mm/dd/yyyy"> 
											                <div class="input-group input-large">
												                <input type="text" class="form-control" id="campaign_from" name="campaign_from" readonly="true" value="<?php echo $campaign['edit_campaign_from']; ?>" />
												                <span class="input-group-addon"> to </span>
												                <input type="text" class="form-control" id="campaign_to" name="campaign_to" value="<?php echo $campaign['edit_campaign_to']; ?>" />
											                </div>                    
										        ...
										        <div class="form-group">
											        <label class="col-md-4 control-label">Per-Click Budget (minimum $0.20)<span class="required" aria-required="true"> * </span></label>
											        <div class="col-md-5">
                                                        <div class="input-group">
											                <span class="input-group-addon">
											                <i class="fa fa-dollar"></i>
											                </span>
												            <input class="form-control" id="campaign_budget_click" name="campaign_budget_click" readonly="true" placeholder="" type="text" value="<?php echo $campaign['edit_campaign_budget_click']; ?>" />
                                                        </div>
                                                        <span id="error_campaign_budget_click"></span>
											        </div>
										        </div>
										        <div class="form-group">
											        <label class="col-md-4 control-label">Daily Budget (minimum $10.00)<span class="required" aria-required="true"> * </span></label>
											        <div class="col-md-5">
                                                        <div class="input-group">
											                <span class="input-group-addon">
											                <i class="fa fa-dollar"></i>
											                </span>
												            <input class="form-control" id="campaign_budget_daily" name="campaign_budget_daily" placeholder="" type="text" value="<?php echo $campaign['edit_campaign_budget_daily']; ?>" />
                                                        </div>
                                                        <span id="error_campaign_budget_daily"></span>
											        </div>
										        </div>
										        <div class="form-group">
											        <label class="col-md-4 control-label">Total Budget (minimum $25.00)<span class="required" aria-required="true"> * </span></label>
											        <div class="col-md-5">
                                                        <div class="input-group">
											                <span class="input-group-addon">
											                <i class="fa fa-dollar"></i>
											                </span>
    												        <input class="form-control" id="campaign_budget_total" name="campaign_budget_total" placeholder="" type="text" value="<?php echo $campaign['edit_campaign_budget_total']; ?>" />
                                                        </div>
											        ...
											        <div class="col-md-5">
                                                        <div class="input-group">
    												        <label style="padding-left:0" class="checkbox-inline">
                                                                <input style="padding-left:0" type="checkbox" id="campaign_agree_terms" name="campaign_agree_terms" value="agree">  I have read and agree to the <a href="paymentterms.html" target="_blank">Payment Terms</a>.
                                                            </label>
                                                        </div>
                                                        <span id="error_campaign_agree_terms"></span>
											        </div>
										        </div>											
											...
											<div class="tab-pane" id="tab2">
                                                 <div class="row">
                                                    <div class="col-md-6">
                                                        <h3>Select Tweets for Campaign</h3>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
				                                    <div class="col-md-12">
    				                                    <div class="col-md-6">
                                                            <h3>Available Tweets <span style="font-size:12px">(click to assign)</span></h3>
                                                            <div style="width:100%" id="tweet-list"></div>
                                                        </div>
	    			                                    <div class="col-md-6">
                                                            <h3>Assigned Tweets</h3>
...
<![endif]-->
    ...
    <script type="text/javascript">
        $(function(){
            var confirmOnPageExit = function (e) 
            {
                ...
                var message = 'You have not saved your campaign.  Are you sure you want to leave?';
    ...
    <script src="inc/tweetedjobs-promocode-edit.js" type="text/javascript"></script>
    <script>
