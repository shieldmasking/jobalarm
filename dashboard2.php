...
//        testAPI(console.log());
            ...
            <div class="container">
                ...
                <div class="row margin-top-10">
                    <div class="col-md-6 col-xs-12">
                        <h1>
                            Welcome, <?php echo $account_data['twitter_handle']; ?>
				...
				<div class="col-md-12 col-sm-12" id="smsCharts">
		         	<div class="portlet light ">
				         <div class="portlet-title">
						       <div class="caption caption-md">
							   <i class="icon-bar-chart theme-font"></i>
							    <span class="caption-subject theme-font bold uppercase"> - SMS Performance</span></div> 
								</div> 
								     <div class="portlet-body" id="smsCharts">
						</div>									        
                </div>
			</div>
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject theme-font bold uppercase">My Sponsored Jobs</span>
                                </div>
                                <div class="actions">
                                <?php if ($_SESSION['account']['billing_plan'] <= 0) : ?>
	...
	<tbody id="joinBody"></tbody>
					...
					<div class="col-md-12 col-sm-12" id="groupManagerCell">
					  ...
					  <?php if ($_SESSION['account']['billing_plan'] >= 3) : ?>
					<a class="btn btn-sm blue" href="http://admin.jobalarm.com/globals"target="_blank">TEXT <i class="fa fa-edit"></i></a>  <?php endif; ?>                              </div>                            </div>                           <div class="portlet-body" id="groupManagerCellBody">
